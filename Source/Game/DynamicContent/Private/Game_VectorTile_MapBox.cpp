...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::BeginPlay);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::GenerateBuildingVertices);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::ExecuteGameThreadLogic);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::ExecuteHelperThreadLogic);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::GlobeReferenceScaleUpdated);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::SetBoundsAndZoomVirtual);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::AddVectorTileActor);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::RequestTiles);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::OnHTTPRequestComplete);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::RequestVectorTile);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::RequestAccess);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::DestroyActors);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::HandleTerrainUpdate);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::PeriodicCheckLOD);
	...
	if (Status == EVectorTileLoadStatus::PendingTerrain)
	{
		...
		if (IsValid(pTileManager))
		{
			if (pTileManager->IsEnabled())
			{
				...
				{
					TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::PeriodicCheckLOD - Loading);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::OnVectorTileFinished);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(VR-TAK UGame_VectorTile_MapBox::BindToTileManager);
