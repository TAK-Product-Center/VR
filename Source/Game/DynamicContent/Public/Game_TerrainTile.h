...
public:
	...
	bool RayTrace(const FVector start, const FVector& dir, FVector& outHit);

	bool IsWorldPartioningReady() const;
	...
	bool IsCoordInBounds(const FGeodeticCoord2D& coord) const;
