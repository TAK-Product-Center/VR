...
struct FSOverlayCategory
{
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere)
    TSubclassOf<class UUserWidget> Item_ListItemClass;

    /* class to use listing categories in this category */
    UPROPERTY(BlueprintReadWrite, EditAnywhere)
    TSubclassOf<class UUserWidget> Category_ListItemClass;
};
...
public:
	...
	*/
	...
	SpatialiteResults QueryClassUID(const FString& classUID) const;
