...
class UGame_UserWidget_RibbonEditor;
class UUserWidget;
...
class GAME_API UGame_Subsystem_Ribbon : public UWorldSubsystem
{
	...
	friend UGame_UserWidget_RibbonEditor;
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	TSubclassOf<AGame_Tool> NullToolClass;
