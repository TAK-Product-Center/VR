...
private:
	...
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPlayerTransformOverrideChanged, const FTransform&, transformOverride);
...
public:
	...
	FOnPlayerTransformOverrideChanged OnPlayerTransformOverrideChanged;
...
private:
	...
	UPROPERTY(ReplicatedUsing = OnRep_PlayerTransformOverride)
...
public:
	...
	UFUNCTION(Server, Reliable, BlueprintCallable)
	void Server_SetPresentingLocked(bool isLocked);

	UFUNCTION(Server, Reliable)
	void Server_SetPlayerTransformOverride(const FTransform& transformOverride);
...
private:
	...
	UFUNCTION()
	void OnRep_PlayerTransformOverride();
