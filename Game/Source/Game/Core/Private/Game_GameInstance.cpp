...
void UGame_GameInstance::PopulateDefaultSettings()
{
	if (UDeveloper_PersistentSettings* gameSettings = GetSubsystem<UGame_Subsystem_Core>()->GetGameSettingsDirect())
	{
		...
		// UGame_TileManager::Initialize() -- set to true in this function
		...
		// UGame_TileManager::Initialize() -- set to 10000.f in this function
		//gameSettings->StoreDefaultSettingDouble(TEXT("TileViewDistance"), 10000.f);
