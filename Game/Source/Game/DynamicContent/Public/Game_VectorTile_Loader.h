...
private:
	...
	static FColor RoofColor;
	static FColor FloorColor;
...
private:
	...
	static FGeodeticCoord3D CalculateWorldPos(const FVector2D& tilePos, const FGeodeticCoord2D& tileNW, const FGeodeticCoord2D& tileSE, double agl, FVector& outWorldPos, AVH_GlobeReferenceActor* globeRef, bool* isRunning);
	...
	static void GetBuildingColors(FColor& outRoofColor, FColor& outFloorColor);
