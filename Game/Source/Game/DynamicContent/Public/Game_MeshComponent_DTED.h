...
public:
	...
	static bool GetHeightData(TArray<double>& haeValues, const FGeodeticCoord2D& northWestBound, const FGeodeticCoord2D& southEastBound, double postSpacingMetersLongitude, double postSpacingMetersLatitude, int32& totalLongitudePosts, int32& totalLatitudePosts);
