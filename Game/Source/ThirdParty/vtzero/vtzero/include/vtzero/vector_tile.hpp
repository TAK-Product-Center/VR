...
namespace vtzero {
	...
	static void PropertyToString(const vtzero::property_value& prop, FString& outStr)
	{
		switch (prop.type())
		{
			case vtzero::property_value_type::bool_value:
			{
				outStr = prop.bool_value() ? TEXT("true") : TEXT("false");
				break;
			}
			case vtzero::property_value_type::sint_value:
			{
				outStr = FString::Printf(TEXT("%d"), prop.sint_value());
				break;
			}
			case vtzero::property_value_type::int_value:
			{
				outStr = FString::Printf(TEXT("%d"), prop.int_value());
				break;
			}
			case vtzero::property_value_type::uint_value:
			{
				outStr = FString::Printf(TEXT("%u"), prop.uint_value());
				break;
			}
			case vtzero::property_value_type::float_value:
			{
				outStr = FString::Printf(TEXT("%f"), prop.float_value());
				break;
			}
			case vtzero::property_value_type::double_value:
			{
				outStr = FString::Printf(TEXT("%f"), prop.double_value());
				break;
			}
			case vtzero::property_value_type::string_value:
			{
				outStr = ANSI_TO_TCHAR(prop.string_value().to_string().c_str());
				break;
			}
		}
	}
