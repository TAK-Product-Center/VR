...
#include "IPLUGIN_NAME.h"

// Engine
#include "Engine.h"
#include "Net/UnrealNetwork.h"

DECLARE_LOG_CATEGORY_EXTERN(PLUGIN_NAME, Warning, All);

class AGame_PluginActor;

class FPLUGIN_NAME : public IPLUGIN_NAME
{
	// ---------------------------------
	// --- Variables
	// ---------------------------------
private:
	const FName PluginName = TEXT("PLUGIN_NAME");
