...
void UUI_Subsystem_Core::FOnUserWidgetClosed_DelegateWrapper(const FMulticastScriptDelegate& OnUserWidgetClosed, UUserWidget* userWidget)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUI_Subsystem_Core_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UUI_Subsystem_Core_GetUserWidgetClassWorldSettings, "GetUserWidgetClassWorldSettings" }, // 3740508890
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Plugins_VH_UI_Source_VH_UI_Subsystems_Public_UI_Subsystem_Core_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUI_Subsystem_Core, UUI_Subsystem_Core::StaticClass, TEXT("UUI_Subsystem_Core"), &Z_Registration_Info_UClass_UUI_Subsystem_Core, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUI_Subsystem_Core), 4021608451U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Plugins_VH_UI_Source_VH_UI_Subsystems_Public_UI_Subsystem_Core_h_3525506619(TEXT("/Script/VH_UI"),
