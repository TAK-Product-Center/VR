...
void UKeyboard_Subsystem_Core::FKeyboardSpawnDestroy_DelegateWrapper(const FMulticastScriptDelegate& KeyboardSpawnDestroy, bool bSpawn, AActor* keyboardContainer)
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Plugins_VH_Keyboard_Source_VH_Keyboard_Subsystems_Public_Keyboard_Subsystem_Core_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UKeyboard_Subsystem_Core, UKeyboard_Subsystem_Core::StaticClass, TEXT("UKeyboard_Subsystem_Core"), &Z_Registration_Info_UClass_UKeyboard_Subsystem_Core, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UKeyboard_Subsystem_Core), 437889897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Plugins_VH_Keyboard_Source_VH_Keyboard_Subsystems_Public_Keyboard_Subsystem_Core_h_3363259145(TEXT("/Script/VH_Keyboard"),
