...
# Import target "assimp::draco" for configuration "Release"
set_property(TARGET assimp::draco APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(assimp::draco PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/draco.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/draco.dll"
  )

list(APPEND _cmake_import_check_targets assimp::draco )
list(APPEND _cmake_import_check_files_for_assimp::draco "${_IMPORT_PREFIX}/lib/draco.lib" "${_IMPORT_PREFIX}/bin/draco.dll" )
