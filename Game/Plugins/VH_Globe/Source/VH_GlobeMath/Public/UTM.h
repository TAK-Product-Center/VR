...
FLOAT ArcLengthOfMeridian(FLOAT phi, FLOAT sm_a, FLOAT sm_b);
...
void MapLatLonToXY(FLOAT phi, FLOAT lambda, FLOAT lambda0, FLOAT& x, FLOAT& y, FLOAT sm_a, FLOAT sm_b);
...
void MapXYToLatLon(FLOAT x, FLOAT y, FLOAT lambda0, FLOAT& phi, FLOAT& lambda, FLOAT sm_a, FLOAT sm_b);
...
int LatLonToUTMXY(FLOAT lat, FLOAT lon, int zone, FLOAT& x, FLOAT& y, FLOAT sm_a, FLOAT sm_b);
...
// Returns:
// The function does not return a value.
void UTMXYToLatLon(FLOAT x, FLOAT y, int zone, bool southhemi, FLOAT& lat, FLOAT& lon, FLOAT sm_a, FLOAT sm_b);
