...
// End Cross Module References
	...
	DEFINE_FUNCTION(AVH_GlobeReferenceActor::execECEFToGeodetic)
	{
		P_GET_STRUCT_REF(FVector,Z_Param_Out_ecef);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FGeodeticCoord3D*)Z_Param__Result=P_THIS->ECEFToGeodetic(Z_Param_Out_ecef);
		P_NATIVE_END;
	}
	...
	void AVH_GlobeReferenceActor::StaticRegisterNativesAVH_GlobeReferenceActor()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ECEFToGeodetic", &AVH_GlobeReferenceActor::execECEFToGeodetic },
	...
	struct Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics
	{
		struct VH_GlobeReferenceActor_eventECEFToGeodetic_Parms
		{
			FVector ecef;
			FGeodeticCoord3D ReturnValue;
		};
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ecef_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_ecef;
		static const UECodeGen_Private::FStructPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ecef_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ecef = { "ecef", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VH_GlobeReferenceActor_eventECEFToGeodetic_Parms, ecef), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ecef_MetaData), Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ecef_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VH_GlobeReferenceActor_eventECEFToGeodetic_Parms, ReturnValue), Z_Construct_UScriptStruct_FGeodeticCoord3D, METADATA_PARAMS(0, nullptr) }; // 3754836998
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ecef,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/VH_GlobeReferenceActor.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVH_GlobeReferenceActor, nullptr, "ECEFToGeodetic", nullptr, nullptr, Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::VH_GlobeReferenceActor_eventECEFToGeodetic_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C20400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::VH_GlobeReferenceActor_eventECEFToGeodetic_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVH_GlobeReferenceActor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AVH_GlobeReferenceActor_ECEFToGeodetic, "ECEFToGeodetic" }, // 2080286446
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Plugins_VH_Globe_Source_VH_Globe_Public_VH_GlobeReferenceActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVH_GlobeReferenceActor, AVH_GlobeReferenceActor::StaticClass, TEXT("AVH_GlobeReferenceActor"), &Z_Registration_Info_UClass_AVH_GlobeReferenceActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVH_GlobeReferenceActor), 3783830519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Plugins_VH_Globe_Source_VH_Globe_Public_VH_GlobeReferenceActor_h_2618257439(TEXT("/Script/VH_Globe"),
