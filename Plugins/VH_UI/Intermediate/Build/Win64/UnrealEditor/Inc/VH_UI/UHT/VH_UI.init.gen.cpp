...
void EmptyLinkFunctionForGeneratedCodeVH_UI_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_VH_UI()
	{
		if (!Z_Registration_Info_UPackage__Script_VH_UI.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UUI_Subsystem_Core_OnUserWidgetOpened__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_VH_UI(Z_Construct_UPackage__Script_VH_UI, TEXT("/Script/VH_UI"), Z_Registration_Info_UPackage__Script_VH_UI, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x92252578, 0xC6AF30B5));
