...
FPluginDescriptor::FPluginDescriptor()
	...
	, bIsSlatedForDeletion(false) // WITH_VH
{
}
...
bool FPluginDescriptor::Read(const FJsonObject& Object, FText* OutFailReason /*= nullptr*/)
{
	...
	Object.TryGetBoolField(TEXT("SlatedForDeletion"), bIsSlatedForDeletion); // WITH_VH
...
void FPluginDescriptor::UpdateJson(FJsonObject& JsonObject) const
{
	...
	JsonObject.SetBoolField(TEXT("SlatedForDeletion"), bIsSlatedForDeletion); // WITH_VH
