...
class UVoiceChannel : public UChannel
{
	...
	// WITH_VH
	DECLARE_MULTICAST_DELEGATE_OneParam(FBunchReceived, TSharedPtr<FVoicePacket>);

	DECLARE_MULTICAST_DELEGATE_OneParam(FBunchSent, TSharedPtr<FVoicePacket>);

	FBunchReceived OnPacketReceived;

	FBunchSent OnPacketSent;
	// end WITH_VH
