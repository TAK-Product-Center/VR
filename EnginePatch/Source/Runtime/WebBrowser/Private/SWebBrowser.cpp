...
#include "Framework/Application/SlateApplication.h" // WITH_VH
...
FReply SWebBrowser::OnFocusReceived(const FGeometry& myGeometry, const FFocusEvent& inFocusEvent)
{
	FSlateApplication::Get().SetKeyboardFocus(BrowserView.ToSharedRef(), EFocusCause::SetDirectly);
