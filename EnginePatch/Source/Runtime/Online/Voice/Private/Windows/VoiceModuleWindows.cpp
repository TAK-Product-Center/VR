...
#include "Runtime/Engine/Public/AudioDevice.h" // WITH_VH
...
bool FVoiceCaptureDeviceWindows::Init()
{
	...
	//if (IHeadMountedDisplayModule::IsAvailable()) // WITH_VH
	if (FAudioDevice::CanUseVRAudioDevice() && IHeadMountedDisplayModule::IsAvailable())  // WITH_VH
	{
