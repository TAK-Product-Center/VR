...
#include "Misc/ScopeTryLock.h" // WITH_VH
...
public:
	...
	FLidarPointCloudPoint* LineTraceSingle(const FLidarPointCloudRay& Ray, const float& Radius, const bool& bVisibleOnly) 
	{
		// WITH_VH
		...
		if (bValidOctree)
		{
			return Octree.RaycastSingle(Ray.ShiftBy(-LocationOffset), Radius, bVisibleOnly);  // WITH_VH (orig was just this line)
		}
