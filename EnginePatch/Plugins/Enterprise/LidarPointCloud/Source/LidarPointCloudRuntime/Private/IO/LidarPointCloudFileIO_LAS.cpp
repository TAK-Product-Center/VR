...
bool ULidarPointCloudFileIO_LAS::HandleImport(const FString& Filename, TSharedPtr<FLidarPointCloudImportSettings> ImportSettings, FLidarPointCloudImportResults& OutImportResults)
{
	...
	{
		//return HandleImportLAS(Filename, OutImportResults);  // WITH_VH
		return HandleImportLAS(Filename, ImportSettings, OutImportResults);  // WITH_VH
	}
#if LASZIPSUPPORTED
	else if (Extension.Equals("laz"))
	{
		//return HandleImportLAZ(Filename, OutImportResults);  // WITH_VH
		return HandleImportLAZ(Filename, ImportSettings, OutImportResults);  // WITH_VH
	}
#endif
	else
	{
...
//bool ULidarPointCloudFileIO_LAS::HandleImportLAS(const FString& Filename, FLidarPointCloudImportResults& OutImportResults)  // WITH_VH
bool ULidarPointCloudFileIO_LAS::HandleImportLAS(const FString& Filename, TSharedPtr<FLidarPointCloudImportSettings> ImportSettings, FLidarPointCloudImportResults& OutImportResults)  // WITH_VH
{
	...
	//const float ImportScale = GetDefault<ULidarPointCloudSettings>()->ImportScale;  // WITH_VH
	const float ImportScale = ImportSettings->ImportScale;  // WITH_VH
...
#if LASZIPSUPPORTED
//bool ULidarPointCloudFileIO_LAS::HandleImportLAZ(const FString& Filename, FLidarPointCloudImportResults& OutImportResults)  // WITH_VH
bool ULidarPointCloudFileIO_LAS::HandleImportLAZ(const FString& Filename, TSharedPtr<FLidarPointCloudImportSettings> ImportSettings, FLidarPointCloudImportResults& OutImportResults)  // WITH_VH
{
