...
public:
	...
	*/
	...
	// WITH_VH
	// transform of box to check for collision; vertices within the box made by this transform will not have collision
	FTransform NoCollisionWithinBoxTransform;

	bool bCutAllCollision;

	int32 GetNumCollisionsQueued() const;

	void UpdateCollisionPublic();
	// end WITH_VH
